package com.vrrv.inscribe.fragments.update
...
import com.vrrv.inscribe.databinding.FragmentUpdateBinding
...
class UpdateFragment : Fragment() {
    ...
    private fun updateItem() {
        ...
        if (validation) {
            // Update Current Item
            val updatedItem = InscribeData(
                args.currentItem.id,
                title,
                mSharedViewModel.parsePriority(getPriority),
                description
            )
            mInscribeViewModel.updateData(updatedItem)
    ...
    private fun confirmItemRemoval() {
        ...
        builder.setPositiveButton("Yes") { _, _ ->
            mInscribeViewModel.deleteItem(args.currentItem)
            Toast.makeText(
                requireContext(),
